...
//
// This function should always delete the user from the user's map, which is a
// map that stores the user's name as keys. It also returns a log string that
// indicates to the caller some information about the user's deletion.
//
