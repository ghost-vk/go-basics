...
//
// Complete the createMatrix function. It takes a number of rows and columns
// and returns a 2D slice of integers where the value of each cell is i * j
// where i and j are the indexes of the row and column respectively.
//
